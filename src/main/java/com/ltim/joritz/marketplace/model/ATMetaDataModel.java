...
public class ATMetaDataModel extends AuditableBaseModel{
	...
	private ATMetaDataSchemaModel atMetaDataSchemaModel;
	 ...
	 private ArtifactTypeModel artifact;
	...
	public ArtifactTypeModel getArtifact() {
		return artifact;
	}



	public void setArtifact(ArtifactTypeModel artifact) {
	...
	public ATMetaDataModel(int atMetaDataId, ATMetaDataSchemaModel atMetaDataSchemaModel, ArtifactTypeModel artifact,
			String value) {
		super();
		this.atMetaDataId = atMetaDataId;
		this.atMetaDataSchemaModel = atMetaDataSchemaModel;
